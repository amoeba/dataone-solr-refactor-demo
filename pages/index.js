...
const Home = ({docs}) => (
  <div>
    ...
    <p>
      ...
      resourceMap field linking the package member to its package, we use a
      Solr join to query for the package members directly:

      <pre>
        <code></code>{query_example}
      </pre>
    </p>
...
Home.getInitialProps = async ( {req} ) => {
  ...
  return { docs: json.response.docs }
}
